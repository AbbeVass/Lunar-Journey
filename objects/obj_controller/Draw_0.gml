...
draw_sprite(spr_GroundBackground, 0, 0, 0); // Byt 'spr_background' till din bakgrundssprite och 0,0 till rätt position
...
shader_set_uniform_f(shader_position, obj_player.x, obj_player.y); // Karaktärens x och y position
